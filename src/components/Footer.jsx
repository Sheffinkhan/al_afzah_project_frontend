...
import MaCoModal from './MaCoModal';

const Footer = () => {
  const [macoOpen, setMacoOpen] = useState(false);
  const quickLinks = [
    { label: 'Home', path: '/' },
  ...
  return (
    <footer className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-gray-500">
              Developed by{' '}
              <span
                onClick={() => setMacoOpen(true)}
                className="text-[#e8171d] font-bold cursor-pointer hover:text-white transition-colors duration-300"
              >
                MaCo
              </span>
            </p>
      ...
      <MaCoModal isOpen={macoOpen} onClose={() => setMacoOpen(false)} />
    </footer>
  );
};
